...
// this component renders individual tweet cards and i have also implemented the functionality of liking , disliking , reply, and retweets.

const FeedCard = ({ tweet, getAllTweets }) => {
    ...
    const like = tweet?.likes.filter(u => u._id === user._id);
    // console.log(tweet);
    ...
    return (<>
        {tweet && <div className='rounded mt-1 border-bottom border-top'>
