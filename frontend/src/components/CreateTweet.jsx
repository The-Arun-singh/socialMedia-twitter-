...
// this is a modal component which is responsible for creating tweets 
const CreateTweet = (props) => {
    ...
    const createTweet = async (e) => {
        ...
        try {
            const res = await fetch("http://localhost:8000/api/tweet", {
                method: "POST",
                headers: {
                    ...
                    <Modal.Body>
                        <div>
                            <div className="w-100 p-3">
                                ...
                                <Form className='p-2' onSubmit={createTweet}>
